...
const Hero = () => {
  ...
  return (
    <div className={`relative min-h-screen font-poppins home__bg ${menuOpen ? 'pt-16' : ''}`}>
      ...
      <Header />
      <section className={`relative z-10 md:mt-20 sm:mt-20 lg:mt-[4cm] lg:ml-[1cm] px-4 ${menuOpen ? 'pt-16' : ''}`} style={{ width: '100%', maxWidth: '1200px' }}>
        <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
          <div className="mb-8 text-left text-white md:mb-0 md:text-left">
            <h1 className="max-w-4xl p-2 pl-4 pr-4 mb-4 text-4xl font-extrabold border-2 border-white md:text-5xl lg:text-8xl md:mb-4 lg:mb-4 font-good">
              TITAN <br /> BASE
            </h1>
          </div>
          <div className="text-white md:ml-20 lg:ml-[7cm]">
            ...
            <p className="text-sm text-justify max-w-sm lg:ml-[7cm] md:text-2xl lg:text-xl">
              You are on the cusp of an extraordinary adventure where knowledge is power and innovation is the ultimate currency. This is a world where brilliant minds converge to shape the future.
            </p>
            ...
            <a href = "https://r.mtdv.me/videos/7RU8e749Iz" target="_blank"
              ...
              <a href = "https://forms.gle/MVqjDWFgssUjhwx39" target="_blank"
                className="px-4 py-2 text-sm text-white border-2 border-white rounded-full md:px-6 lg:px-8 md:py-3 lg:py-4 md:text-base lg:text-lg hover:bg-white hover:text-black"
              >
                Register
              </a>
