...
import instruction from '../../../assets/e33.mp4'; // Updated video path
import image1 from '../../../assets/e34.webp'; // Example image paths
import image2 from '../../../assets/e35.webp';
import image3 from '../../../assets/e36.webp';
...
const Instructions = () => {
  const instructions = [
    ...
    },
    {
      image: image3,
      subtitle: "Software",
      description: "Teammates should be familiar with atleast on of the above mentioned software.",
    },
  ];
