...
import event15 from '../../../assets/e811.webp'; // Updated image
import e27 from '../../../assets/e85.webp'; // New background image
      ...
      <div className="relative w-full p-4 bg-black rounded-lg shadow-xl md:p-8 bg-opacity-70 max-w-none drop-shadow-xl">
        <div className="flex flex-col items-center md:flex-row-reverse">
          ...
          <div className="w-full max-w-2xl mt-4 text-center md:mt-8 md:text-left">
            ...
            • Teams will generate code using a surprise AI tool without GitHub <br></br>
            • A panel of experienced judges will evaluate the submissions.<br></br>
            • The top 3 teams will be awarded cash prizes.<br></br>
            </p>
          </div>
        </div>
      </div>
