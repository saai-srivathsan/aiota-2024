...
import e31 from '../../../assets/e511.mp4';
        ...
        <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
          ...
          <div className="text-white md:ml-20 lg:ml-[7cm]">
            <p className="text-lg font-bold text-justify lg:ml-[7cm] md:text-2xl lg:text-xl">
              Welcome to Ocean Realm!
            </p>
            <p className="text-sm text-justify max-w-sm lg:ml-[7cm] md:text-2xl lg:text-xl">
              Immerse yourself in a magical underwater world. Discover groundbreaking projects and technological marvels deep beneath the waves. Dive in and explore the boundless creativity that awaits in the depths of the Ocean Realm!
            </p>
