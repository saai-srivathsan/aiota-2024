...
import e42 from '../../../assets/e73.webp';
import image1 from '../../../assets/e77.webp'; // Example image paths
import image2 from '../../../assets/e78.webp';
import image3 from '../../../assets/e79.webp';
...
const Instructions = () => {
  const instructions = [
    ...
    },
    {
      image: image3,
      subtitle: "Questions",
      description: "Any questions or issues should be directed to the event coordinators.",
    },
  ];
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden text-white font-poppins">
      ...
      <div className="relative z-10 w-full max-w-6xl px-4 py-16 text-center md:px-8">
        ...
        Before you dive into the heart of the clockwork city, take a moment to follow the essential instructions!        
        </h1>
